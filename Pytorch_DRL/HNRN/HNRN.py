...
class HNRN(nn.Module):
    def __init__(self, train_type, max_buffer, state_dim, sensor_dim, action_dim, mu, theta, sigma, actor_lr, critic_lr, batch_size, gamma, tau, hmm_state):
    ...
    def navigation(self, current_state):
        ...
        collision_avoidance_action = self.actor_ca(sensor=sensor).cpu().data.numpy()
